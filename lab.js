...
if (temperature > 80 && rain == true){
  console.log ('Todays weather allows for a t-shirt, make sure to take an umbrella!');
} else if (temperature < 80 && temperature > 60) {
  console.log('Today calls for a rain-jacket!');
} else if (temperature < 60 && rain == true) {
    console.log('Wear a jacket and take an umbrella today.');
}else if (temperature > 80 && rain == false) {
  console.log ('Its a sunny day! Shorts and sandals approved.');
}else if (temperature > 80 && cloudy == true) {
  console.log ('Todays weather might be a little windy, take a sweater!');
}
...
for (let i=0; i < 10; console.log ('hello'))
i++
